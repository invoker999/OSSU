...
class compilationEngine():
    ...
    def __init__(self, jackFile,xmlFile,vmFile,debug = True):
        '''
        ...
        self.tokensGen = JackTokenizer.jackTokenizer(jackFile,genTXML=False)
        ...
        #Create a vm file for compilation 
        try:
            self.vmFile = open(vmFile,"w")
        except:
            print("Could not create vm output file :",vmFile)
